...
def calc_fcf_margin(cashflow_df, income_df):
    ...
    merged['FCF_Margin'] = merged['FCF_Margin'].round(2)
...
def calc_net_margin(income_df):
    ...
    income_df['Net_Margin'] = income_df['Net_Margin'].round(2)
...
def calc_dbr(balance_df):
    ...
    balance_df['Debt_Burden_Ratio'] = balance_df['Debt_Burden_Ratio'].round(2)
